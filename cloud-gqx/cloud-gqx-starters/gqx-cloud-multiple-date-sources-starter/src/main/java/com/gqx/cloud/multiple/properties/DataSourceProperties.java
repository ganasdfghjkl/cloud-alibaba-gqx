package com.gqx.cloud.multiple.properties;
...
public class DataSourceProperties {
    ...
    public List<DataSourceInfoProperties> getSources() {
        return sources;
    }

    public void setSources(List<DataSourceInfoProperties> sources) {
        this.sources = sources;
    }

    public static class DataSourceInfoProperties{
